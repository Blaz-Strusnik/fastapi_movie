...
from fastapi_movie_app.db.dependencies import get_db_session
from fastapi_movie_app.db.utils import create_database, drop_database
from fastapi_movie_app.services.rabbit.dependencies import get_rmq_channel_pool
from fastapi_movie_app.services.rabbit.lifetime import init_rabbit, shutdown_rabbit
from fastapi_movie_app.services.redis.dependency import get_redis_pool
from fastapi_movie_app.settings import settings
from fastapi_movie_app.web.application import get_app
...
async def _engine() -> AsyncGenerator[AsyncEngine, None]:
    ...
    :yield: new engine.
    """
    from fastapi_movie_app.db.meta import meta  # noqa: WPS433
    from fastapi_movie_app.db.models import load_all_models  # noqa: WPS433
